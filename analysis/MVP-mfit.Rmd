...
Here we provide with an overview of how the mash fit was conducted for a presorted set of summary statistics across the four lipid traits and provide the model fit object (`mfitMVP.rds`) so that users can recreat. 
...
2) Read in a prepruned matrix of maximum statistics across LD blocks
...
4) estimate covarianve matrices Uk
```{r,eval=F}
