...
par(mfrow=c(1,2))
plot(prs_quantiles,p,main="predicted risk vs PRS quantiles")
plot(ldl_quantiles,l,main="predicted risk vs LDL-adj quantiles")

par(mfrow=c(1,2))
plot(ecdf(p),main="CDF of predicted risk using PRS",xlab="Predicted Risk")
plot(ecdf(l),main="CDF of predicted risk using LDL-adjusted",xlab="Predicted Risk")
```
