...
To answer the question: at what quantiles is the risk predicted by PRS equivalnet to LDL>190,
first we find the risk equivalency of LDL>190:
...
Now, we ask which quantils of PRS risk are greater than or equal to this:
```{r}
min(r[which(p>m)])
```
So the 67% of PRS risk is equivalent to LDL >190.
