...
```{r}
par(mfrow=c(1,3))
plot(prs_quantiles,p,main="predicted risk vs PRS quantiles",ylab="Predicted Risk of CAD")
plot(ldl_quantiles,l,main="predicted risk vs LDL-adj quantiles",ylab="Predicted risk of CAD")
plot(df$LDL_adj,l,main="predicted risk vs LDL-adj")
